...
canvas_Page = int(input("What Canva page would you like to load into Todoist\n1 LACCD\n2 ECRCHS\n3 VCCCD\n4 RSCCD\n"))

if canvas_Page == 1: 
    data['canvas_api_key'] = "TOKEN 1"
elif canvas_Page == 2: 
    data['canvas_api_key'] = "TOKEN 2"
elif canvas_Page == 3:
    data['canvas_api_key'] = "TOKEN 3"
elif canvas_Page == 4:
    data['canvas_api_key'] = "TOKEN 4"
...
print(canvas_Page)
print(data['canvas_api_key'])
print(data['courses'])  # Print the updated "courses" field
